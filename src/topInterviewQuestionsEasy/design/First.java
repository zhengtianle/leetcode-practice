package topInterviewQuestionsEasy.design;
...
public class First {
    ...
    /** Resets the topInterviewQuestionsEasy.array to its original configuration and return it. */
    public int[] reset() {
        result = Arrays.copyOf(nums, nums.length);
        return result;
    }

    /** Returns a random shuffling of the topInterviewQuestionsEasy.array. */
    /**
     * 洗牌的正确姿势：
